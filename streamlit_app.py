...
st.set_page_config(
    ...
    layout="wide", # هذه الخاصية أساسية لتوسيع الصفحة
...
def run_main_app():
    ...
    # هذا الجزء مهم جداً لتوسيع عرض الصفحة الرئيسية في Streamlit
    components.html("""
    <style>
    /* تجاوز الحد الأقصى لعرض حاوية المحتوى الرئيسية لـ Streamlit */
    /* هذا يضمن أن المحتوى يمكن أن يمتد على كامل عرض المتصفح */
    .stApp > div:first-child > div:nth-child(1) > div > div > div:nth-child(2) { /* استهداف أعمق لضمان التأثير */
        max-width: none !important;
    }
    .stApp > div:first-child > div:nth-child(1) > div {
    ...
    if st.session_state.get("search_done", False):
        ...
        if results:
            ...
            for i, r in enumerate(filtered):
                # هنا قمنا بإزالة st.columns لأن layout="wide" والـ CSS أعلاه يجب أن يكون كافيًا
                # لجعل الـ expander يأخذ العرض الكامل.
